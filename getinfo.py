...
fig_resultados.write_image("images/fig_resultados.png", width=700, height=420)
fig_4.write_image("images/fig_4.png", width=700, height=420)
fig_6.write_image("images/fig_6.png", width=700, height=420)
fig_12.write_image("images/fig_12.png", width=700, height=420)
fig_1.write_image("images/fig_1.png", width=700, height=420)
fig_7.write_image("images/fig_7.png", width=700, height=420)
fig_10.write_image("images/fig_10.png", width=700, height=420)
fig_3.write_image("images/fig_3.png", width=700, height=420)
fig_8.write_image("images/fig_8.png", width=700, height=420)
fig_13.write_image("images/fig_13.png", width=700, height=420)
fig_2.write_image("images/fig_2.png", width=700, height=420)
fig_11.write_image("images/fig_11.png", width=700, height=420)
fig_14.write_image("images/fig_14.png", width=700, height=420)
fig_13.write_image("images/fig_13.png", width=700, height=420)
fig_5.write_image("images/fig_5.png", width=700, height=420)
fig_9.write_image("images/fig_9.png", width=700, height=420)
fig_15.write_image("images/fig_15.png", width=700, height=420)
wordcloud.to_file("images/wordcloud.png")
fig_enps.write_image("images/fig_enps.png", width=700, height=420)
fig_tendencia.write_image("images/fig_tendencia.png", width=700, height=420)
...
for paragraph in doc.paragraphs:
    replace_placeholder_with_image(paragraph, '{fig_resultados}', 'images/fig_resultados.png', width_inches=6.5)

for table in doc.tables:
    replace_placeholder_with_image_in_table(table, '{fig_4}', 'images/fig_4.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_6}', 'images/fig_6.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_12}', 'images/fig_12.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_1}', 'images/fig_1.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_7}', 'images/fig_7.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_10}', 'images/fig_10.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_3}', 'images/fig_3.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_8}', 'images/fig_8.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_13}', 'images/fig_13.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_2}', 'images/fig_2.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_11}', 'images/fig_11.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_14}', 'images/fig_14.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_5}', 'images/fig_5.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_9}', 'images/fig_9.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{fig_15}', 'images/fig_15.png', width_inches=3)
    replace_placeholder_with_image_in_table(table, '{wordcloud}', 'images/wordcloud.png', width_inches=5)
    ...
    replace_placeholder_with_image_in_table(table, '{fig_enps}', 'images/fig_enps.png', width_inches=4)
    replace_placeholder_with_image_in_table(table, '{fig_tendencia}', 'images/fig_tendencia.png', width_inches=6)
